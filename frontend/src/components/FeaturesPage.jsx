...
export default function FeaturesPage() {
  return (
    <div className="bg-white py-24 sm:py-32 font-main">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-5">
          ...
          <div className="col-span-2">
            ...
            <p className="mt-6 text-base text-grey-text">
          ...
          {/* Features List */}
          <dl className="col-span-3 grid grid-cols-1 gap-x-8 gap-y-10 text-base text-grey-text sm:grid-cols-2 lg:gap-y-16">
            {features.map((feature) => (
              <div key={feature.name} className="relative pl-9">
                <dt className="font-semibold text-black">
                  <feature.icon 
                    aria-hidden="true" 
                    className="absolute top-1 left-0 h-5 w-5 text-main" 
                  />
                  {feature.name}
                </dt>
                <dd className="mt-2">
